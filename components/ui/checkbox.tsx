  ...
  return (
    <CheckboxPrimitive.Root
      ...
      className={cn(
        ...
        "dark:data-[state=checked]:bg-primary data-[state=checked]:border-primary-muted focus-visible:border-ring focus-visible:ring-ring/50",
    ...
    >
      ...
      >
        {/* <FaCheck className="size-2.5 text-primary-lightest" /> */}
      </CheckboxPrimitive.Indicator>
    </CheckboxPrimitive.Root>
  );
}
